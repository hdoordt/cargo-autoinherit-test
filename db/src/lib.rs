//! The cargo-autoinherit-test-db crate contains all code related to database access: entities, migrations, functions for validating and reading and writing data.
...
/// Creates a connection pool to the database specified in the passed [`cargo-autoinherit-test-config::DatabaseConfig`]
